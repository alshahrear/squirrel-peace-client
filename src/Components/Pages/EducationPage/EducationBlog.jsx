...
const EducationBlog = ({ educationBlog, onDelete, onUpdate, searchTerm }) => {
  const { _id, blogTitle, blogRandom, blogShortDescription, blogCategory, blogImage, blogDate } = educationBlog;
