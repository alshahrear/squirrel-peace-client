        ...
        <div className="bg-[#222426]">
            <footer className="footer flex max-w-screen-xl mx-auto  text-[#878787] pt-10 pb-10">
                ...
                <nav className="flex-1 space-y-2">
                    ...
                    <p className="text-[16px]">
                        <NavLink>-  <span className="inline-block transition-all duration-300 hover:-translate-x-1 hover:text-[#2acb35]"> Contact Us</span></NavLink>
                    </p>
                    <p className="text-[16px]">
                        <NavLink>-  <span className="inline-block transition-all duration-300 hover:-translate-x-1 hover:text-[#2acb35]"> FAQ</span></NavLink>
                    </p>
