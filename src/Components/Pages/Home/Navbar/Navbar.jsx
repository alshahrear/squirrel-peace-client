       ...
       <div className="bg-[#f7f7f7]">
         <div className="navbar max-w-screen-xl mx-auto ">
            ...
            <div className="navbar-end">
                <button className="btn px-8 py-6 rounded-full text-white border-2 bg-[#2acb35] hover:text-[#404040]  hover:bg-white hover:border-[#2acb35]  "><span className="relative text-lg font-medium ">Sign In</span>  
                    <GiCurledLeaf className="absolute text-2xl top-4 ml-20"></GiCurledLeaf></button>
            </div>
        </div>
       </div>
    );
