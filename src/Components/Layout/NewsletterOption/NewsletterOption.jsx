  ...
  return (
    <div>
      <Marquee
        speed={50}
        gradient={false}
        className="py-2 text-lg font-medium bg-[#98c443] text-white"
      >
      ...
      <div className="bg-[#2acb35]">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between max-w-screen-xl mx-auto py-3 gap-8 relative">

          {/* Left Text */}
          <h2 className="text-3xl lg:text-3xl font-extrabold text-white text-center lg:text-left z-10">
