...
import LetterFaq from "./LetterFaq";
...
const LetterFaqs = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:5000/letterFaq")
            .then((res) => res.json())
    ...
    return (
        <div className="mt-10">
            <div className="pb-5 flex items-center justify-between">
                <h2 className="text-2xl font-bold">Letter FAQs <span className="text-[#2acb35]">__</span></h2>
                <button
            ...
            <div className="-mt-3 max-w-screen-xl mx-auto">
                <p className="text-xl font-semibold">
                    <span className="text-[#2acb35] font-bold">Note:</span> If you have more question, please visit our {" "}
