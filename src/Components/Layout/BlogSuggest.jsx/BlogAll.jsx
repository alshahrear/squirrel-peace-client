...
const BlogAll = () => {
    ...
    // এই চারটি route এর ভিতর থাকলে filter করব
    const pageRoutes = ["/lifeStylePages", "/travelPages", "/healthPages", "/storyPages"];

    const currentPath = location.pathname;

    // যদি current path pageRoutes এর ভিতরে থাকে, তাহলে ঐ route বাদ দিব
