        ...
        <div className="">
            ...
            <div className="max-w-screen-xl mx-auto mt-10 px-4">
                <div className="text-center space-y-2 mb-10">
                    ...
                    <p> We are ECO Green, Our Mission is save water, animals, power energy, natutre <br className="hidden md:block" /> and our environment our activities are taken around the world.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="">
                        <h3 className="text-xl font-bold text-[#2acb35]">
