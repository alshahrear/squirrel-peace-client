        ...
        <div>
                ...
                <div className="py-10 rounded-2xl">
                    ...
                    <div className="grid lg:grid-cols-2 gap-10 max-w-7xl mx-auto px-4">
                        ...
                        <div className="grid grid-cols-2 gap-4 sm:gap-5">
                            {[newscover, newsletter, testimonial, newscover].map((img, idx) => (
                                <div key={idx} className="relative overflow-hidden rounded-xl group">
                                    <img
                                        className="w-full h-40 sm:h-60 object-cover rounded-xl transform transition-transform duration-500 group-hover:scale-110"
                                        src={img}
                                        alt={`Newsletter ${idx}`}
                                    />
                        ...
                        <div className="space-y-6 flex flex-col justify-center">
                            <h2 className="text-2xl sm:text-3xl font-bold text-[#082c2f]">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                                {["Safe Environment", "Dirty Recycling"].map((item, index) => (
                                    <p
                                        key={index}
                                        className="group relative flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-white text-base sm:text-xl font-semibold rounded-xl overflow-hidden cursor-pointer transition-all duration-500"
                                    >
                                        ...
                                        <FaBookReader className="text-xl sm:text-2xl text-[#2acb35] z-10 group-hover:text-white transition-colors duration-300" />
                            ...
                            <div className="bg-[#f7f7f7] rounded-xl space-y-5 sm:space-y-6 p-4" ref={progressRef}>
                                {skills.map((skill, index) => (
                                    <div key={index}>
                                        ...
                                        <div className="w-full h-2 sm:h-3 bg-[#d0e0d5] rounded-full overflow-hidden">
            ...
            <div className="rounded-2xl">
                <div className="text-center space-y-3 pb-10 bg-[#f7f7f7] px-4">
                    ...
                    <p className="text-base sm:text-lg text-gray-700 font-medium max-w-3xl mx-auto">
            ...
            <div className="bg-[#f7f7f7]">
                <div className="max-w-7xl mx-auto px-4 pb-10 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                    <div>
                        ...
                        <NavLink to="/success">
                            <button className="mt-6 bg-[#2acb35] hover:bg-green-700 text-white font-semibold px-6 py-2 rounded-full text-sm sm:text-base">
                                View More
                            </button>
                        </NavLink>
                    </div>
