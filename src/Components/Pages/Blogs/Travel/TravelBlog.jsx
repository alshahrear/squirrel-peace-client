...
const TravelBlog = ({ travelBlog, onDelete, onUpdate, searchTerm }) => {
  const { _id, blogTitle, blogRandom, blogShortDescription, blogCategory, blogImage, blogDate } = travelBlog;
