    ...
    <div className="my-10 max-w-screen-xl mx-auto px-4">
      ...
      <div className="text-center space-y-3 mb-8">
        ...
        <p className="max-w-5xl mx-auto">
          This page allows you to view all messages submitted by users through the contact form. You can review their questions, feedback, or concerns and respond to them via email. Please handle each message with attention and professionalism, as your replies represent the support and care of our platform.
        </p>
        <NavLink to="/contact">
